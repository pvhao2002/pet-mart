  ...
  return (
    <div className='app'>
      <Routes>
        ...
        <Route
          path='/admin'
          element={isAdmin === 'true' ? <Admin /> : <Navigate to='/' replace={true} />}
        />
        <Route
          path='/admin/add'
          element={isAdmin === 'true' ? <AddProduct /> : <Navigate to='/' replace={true} />}
        />
        <Route
          path='/admin/edit/:id'
          element={isAdmin === 'true' ? <EditProduct /> : <Navigate to='/' replace={true} />}
        />
      </Routes>
    </div>
  )
